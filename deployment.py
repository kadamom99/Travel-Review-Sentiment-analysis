...
pickle_in = open(r"C:\Users\Omkar Kadam\OneDrive\Desktop\Web Scrapping\MMT_model.pkl", 'rb')
model = pickle.load(pickle_in)

pickle_in = open(r"C:\Users\Omkar Kadam\OneDrive\Desktop\Web Scrapping\vectorizer.pkl", 'rb')
vectorizer = pickle.load(pickle_in)

# Title of the application
st.header("Predict Ratings for Travel Reviews")
